...
export const KIT = {
  fr: {
    ...
    beyondIntro: "Mêmes données, mêmes règles (gratuit, attribution « firesight.io ») :",
    ...
    badgeText: "Si vous affichez des données FireSight hors du widget (API, CSV), ajoutez ce badge ou la mention « Données : firesight.io » avec un lien. Logos en SVG, libres pour cet usage :",
    badgeHtmlLabel: "Code HTML du badge",
    logosLabel: "Télécharger les logos",
    contact: "Une intégration particulière (volumes, webhooks, format, co-branding) ? Écrivez à contact@firesight.io, réponse rapide.",
  },
  en: {
    ...
    beyondIntro: "Same data, same rules (free, credit “firesight.io”):",
    ...
    badgeText: "If you display FireSight data outside the widget (API, CSV), add this badge or the mention “Data: firesight.io” with a link. SVG logos, free for this use:",
    badgeHtmlLabel: "Badge HTML",
    logosLabel: "Download logos",
    contact: "A specific integration (volumes, webhooks, format, co-branding)? Write to contact@firesight.io, fast reply.",
  },
  es: {
    ...
    beyondIntro: "Mismos datos, mismas reglas (gratis, mención « firesight.io »):",
    ...
    badgeText: "Si muestras datos de FireSight fuera del widget (API, CSV), añade esta insignia o la mención « Datos: firesight.io » con un enlace. Logotipos en SVG, libres para este uso:",
    badgeHtmlLabel: "HTML de la insignia",
    logosLabel: "Descargar logotipos",
    contact: "¿Una integración particular (volúmenes, webhooks, formato, co-branding)? Escribe a contact@firesight.io.",
  },
  pt: {
    ...
    beyondIntro: "Mesmos dados, mesmas regras (grátis, menção « firesight.io »):",
    ...
    badgeText: "Se você exibe dados do FireSight fora do widget (API, CSV), adicione este selo ou a menção « Dados: firesight.io » com um link. Logotipos em SVG, livres para este uso:",
    badgeHtmlLabel: "HTML do selo",
    logosLabel: "Baixar logotipos",
    contact: "Uma integração específica (volumes, webhooks, formato, co-branding)? Escreva para contact@firesight.io.",
  },
} as const;

export const BADGE_HTML = (lang: "fr" | "en" | "es" | "pt") =>
  `<a href="https://firesight.io/${lang}" title="FireSight"><img src="https://firesight.io/brand/badge-firesight-${lang === "fr" ? "fr" : "en"}.svg" alt="${lang === "fr" ? "Données : firesight.io" : "Data: firesight.io"}" height="28" /></a>`;
