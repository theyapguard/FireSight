...
const T = {
    ...
    sections: [
      ...
      },
      {
        ...
        paras: [
          ...
          "Certains guides contiennent des liens d'affiliation Amazon : en tant que Partenaire Amazon, FireSight réalise un bénéfice sur les achats remplissant les conditions requises. Ces liens n'utilisent pas de cookie déposé par firesight.",
        ],
      },
      {
        h2: "Vos droits",
        paras: [
          "Conformément au RGPD, vous disposez d'un droit d'accès, de rectification et de suppression des données vous concernant (par exemple un signalement que vous avez envoyé). Écrivez-nous : contact@firesight.io.",
          "Les données de FireSight sont hébergées dans l'Union européenne et aux États-Unis chez nos prestataires techniques (hébergement et base de données).",
        ],
      },
    ],
  ...
  en: {
    metaTitle: "Privacy and cookies | FireSight",
    metaDesc:
      "What FireSight collects (very little), what we do not collect, advertising cookies and your rights.",
    h1: "Privacy and cookies",
    updated: "Last updated: August 14, 2026.",
    sections: [
      {
        h2: "What FireSight collects",
        paras: [
          "FireSight works without accounts or signup. We measure the site's audience minimally: page views, country of origin (derived from the IP address, never stored in clear), device type and referring site. These measurements rely on an anonymized technical identifier that cannot identify you.",
      ...
      },
      {
        ...
        paras: [
          ...
          "Some guides contain Amazon affiliate links: as an Amazon Associate, FireSight earns from qualifying purchases. These links do not use cookies set by firesight.",
        ],
      },
      {
        h2: "Your rights",
        paras: [
          "Under the GDPR you have the right to access, rectify and delete data about you (for example a report you submitted). Write to us: contact@firesight.io.",
          "FireSight's data is hosted in the European Union and the United States by our technical providers (hosting and database).",
        ],
      },
    ],
