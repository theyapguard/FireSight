...
const T = {
  fr: {
    ...
    metaTitle: "Suivi Canadair en direct : carte des bombardiers d'eau | FireSight",
    metaDesc:
    ...
    howText:
      "Chaque appareil diffuse sa position par ADS-B (le même signal que les avions de ligne). FireSight agrège ces signaux via un réseau communautaire mondial et filtre les moyens de lutte anti-incendie : Canadair CL-415 et CL-215, Air Tractor AT-802 Fire Boss, S-2T Turbo Tracker, DC-10 et BAe 146 Air Tankers, hélicoptères bombardiers d'eau (S-64 Air Crane, Chinook, Firehawk). Le suivi est rafraîchi environ toutes les 15 secondes, avec un mouvement interpolé entre deux signaux.",
    fleet: "La flotte française : Pélican, Milan, Dragon",
    fleetText:
      "La Sécurité Civile française aligne 12 Canadair CL-415 (indicatif « Pélican »), 6 Dash 8-402MR (« Milan », gros porteurs polyvalents) et des hélicoptères EC145 (« Dragon », secours). Basés à Nîmes-Garons, ils sont suivis individuellement par FireSight dès qu'ils décollent, grâce à leur identifiant unique — même quand leur type n'est pas diffusé. Un grand merci à Henri (canadair-tracker) pour la cartographie de la flotte.",
    why: "Pourquoi je ne vois aucun Canadair près d'un feu ?",
    whyText:
      "Trois explications possibles : il fait nuit (pas de largage de nuit), les moyens engagés sont des hélicoptères locaux ou militaires qui ne diffusent pas leur position publiquement, ou l'appareil a coupé son transpondeur. FireSight affiche tout ce qui émet publiquement — c'est déjà l'essentiel des Canadair européens et des tankers nord-américains.",
    faq: [
      {
        q: "Comment suivre les Canadair en direct ?",
        a: "Ouvrez la carte firesight.io : les bombardiers d'eau en vol y apparaissent en temps réel, avec leur vitesse et leur altitude, aux côtés des feux détectés par satellite. Le suivi est gratuit, sans inscription, sur mobile comme sur ordinateur.",
      },
      {
        q: "Où sont les Canadair en ce moment ?",
        a: "La carte firesight.io affiche en temps réel la position de tous les Canadair et bombardiers d'eau qui émettent en ADS-B dans le monde : Italie, France, Croatie, Grèce, Espagne, Amérique du Nord, Australie. Cliquez sur un appareil pour voir son modèle, sa nationalité, sa vitesse et son altitude.",
      },
      {
        q: "Les Canadair sont-ils visibles sur Flightradar24 ?",
        a: "En partie : les trackers généralistes noient les Canadair parmi des milliers d'avions de ligne. FireSight ne montre que les moyens anti-incendie, sur la même carte que les départs de feu, le vent et les points d'eau : on comprend la mission, pas seulement la position.",
      },
      {
        q: "Peut-on suivre les Canadair français (Pélican) en vol ?",
        a: "Oui : les 12 Canadair CL-415 « Pélican » et les 6 Dash 8 « Milan » de la Sécurité Civile sont suivis individuellement par FireSight dès qu'ils décollent de Nîmes-Garons pour une mission feu.",
      },
      {
  ...
  en: {
    ...
    metaTitle: "Track Canadair water bombers live: firefighting aircraft map | FireSight",
    metaDesc:
    ...
    kn: "kn",
    ft: "ft",
    how: "How does FireSight track water bombers?",
    howText:
      "Every aircraft broadcasts its position via ADS-B (the same signal as airliners). FireSight aggregates these signals through community ADS-B networks and filters firefighting assets: Canadair CL-415/CL-215, Air Tractor Fire Boss, S-2T Turbo Tracker, DC-10 and BAe 146 air tankers, and firefighting helicopters (S-64 Air Crane, Chinook, Firehawk). Positions refresh about every 15 seconds, with interpolated movement in between.",
    fleet: "The French fleet: Pélican, Milan, Dragon",
    fleetText:
      "France's Sécurité Civile operates 12 Canadair CL-415s (callsign “Pélican”), 6 Dash 8-402MRs (“Milan”) and EC145 rescue helicopters (“Dragon”), based at Nîmes-Garons. FireSight tracks each airframe individually as soon as it takes off, thanks to its unique transponder ID. Credits to Henri (canadair-tracker) for mapping the fleet.",
    why: "Why don't I see any aircraft near a fire?",
    whyText:
      "Three possible reasons: it's night (no night drops), the assets engaged are local or military helicopters that don't broadcast publicly, or the transponder is off. FireSight shows everything publicly broadcasting — which covers most European Canadairs and North American tankers.",
    faq: [
      {
        q: "How can I track water bombers live?",
        a: "Open the firesight.io map: airborne water bombers appear in real time with their speed and altitude, next to satellite-detected fires. Tracking is free, no signup, on mobile and desktop.",
      },
      {
        q: "Where are the Canadairs right now?",
        a: "The firesight.io map shows the real-time position of every Canadair and water bomber broadcasting ADS-B worldwide: Italy, France, Croatia, Greece, Spain, North America, Australia. Click an aircraft for its model, nationality, speed and altitude.",
      },
      {
        q: "Are Canadairs visible on Flightradar24?",
        a: "Partially: generic flight trackers bury them among thousands of airliners. FireSight shows only firefighting assets, on the same map as fire detections, wind and water points, so you understand the mission, not just the position.",
      },
      {
        q: "Can I track the French Pélican Canadairs in flight?",
        a: "Yes: the 12 CL-415 “Pélican” and 6 Dash 8 “Milan” of the French Sécurité Civile are tracked individually by FireSight as soon as they take off from Nîmes-Garons.",
      },
      {
  ...
  es: {
    title: "Aviones cisterna en vivo: medios aéreos contra incendios | FireSight",
    metaTitle: "Aviones cisterna en vivo: posición en tiempo real | FireSight",
    metaDesc:
    ...
    howText:
      "Cada aeronave emite su posición por ADS-B (la misma señal que los aviones de línea). FireSight agrega esas señales a través de redes comunitarias mundiales y filtra los medios contra incendios: Canadair CL-415 y CL-215, Air Tractor AT-802 Fire Boss (muy usado en Chile, Argentina y España), S-2T Turbo Tracker, tanqueros DC-10 y BAe 146, helicópteros (S-64 Air Crane, Chinook, Firehawk). Las posiciones se refrescan cada 15 segundos aproximadamente, con movimiento interpolado.",
    fleet: "Las flotas: Europa, América y la Sécurité Civile francesa",
    fleetText:
      "Italia opera la mayor flota europea de Canadair, seguida por España, Grecia y Croacia; Francia alinea 12 CL-415 « Pélican » y 6 Dash 8 « Milan » con base en Nîmes-Garons, seguidos individualmente por FireSight desde el despegue. En América, Chile y Argentina recurren a Fire Boss y helicópteros contratados, y Norteamérica a grandes tanqueros terrestres.",
    why: "¿Por qué no veo ningún avión cerca de un incendio?",
    whyText:
      "Tres explicaciones posibles: es de noche (no hay descargas nocturnas), los medios comprometidos son helicópteros locales o militares que no emiten públicamente, o la aeronave apagó su transpondedor. FireSight muestra todo lo que emite públicamente, que ya cubre la mayoría de los Canadair europeos y los tanqueros norteamericanos.",
    faq: [
      {
        q: "¿Cómo seguir los aviones contra incendios en vivo?",
        a: "Abre el mapa firesight.io: los aviones cisterna en vuelo aparecen en tiempo real, con su velocidad y altitud, junto a los incendios detectados por satélite. El seguimiento es gratuito, sin registro, en celular y computadora.",
      },
      {
        q: "¿Dónde están los Canadair ahora mismo?",
        a: "El mapa firesight.io muestra en tiempo real la posición de todos los Canadair y aviones cisterna que emiten ADS-B en el mundo: Italia, Francia, Croacia, Grecia, España, Norteamérica, Australia. Haz clic en una aeronave para ver su modelo, nacionalidad, velocidad y altitud.",
      },
      {
        q: "¿Los aviones contra incendios aparecen en Flightradar24?",
        a: "En parte: los rastreadores generalistas los pierden entre miles de aviones de línea. FireSight muestra solo los medios contra incendios, en el mismo mapa que los focos, el viento y los puntos de agua: se entiende la misión, no solo la posición.",
      },
      {
        q: "¿Qué aviones se usan contra los incendios en América Latina?",
        a: "Chile y Argentina emplean sobre todo Air Tractor AT-802 Fire Boss y helicópteros contratados; Brasil usa aviones agrícolas adaptados. Cuando emiten ADS-B, FireSight los muestra en vivo sobre las zonas de fuego.",
      },
      {
  ...
  pt: {
    title: "Aviões-tanque ao vivo: meios aéreos de combate a incêndios | FireSight",
    metaTitle: "Aviões-tanque ao vivo: posição em tempo real | FireSight",
    metaDesc:
    ...
    howText:
      "Cada aeronave transmite sua posição por ADS-B (o mesmo sinal dos aviões de linha). O FireSight agrega esses sinais por redes comunitárias mundiais e filtra os meios de combate a incêndios: Canadair CL-415 e CL-215, Air Tractor AT-802 Fire Boss (muito usado no Brasil e no Chile), S-2T Turbo Tracker, tanqueiros DC-10 e BAe 146, helicópteros (S-64 Air Crane, Chinook, Firehawk). As posições se atualizam a cada 15 segundos, com movimento interpolado.",
    fleet: "As frotas: Europa, Américas e a Sécurité Civile francesa",
    fleetText:
      "A Itália opera a maior frota europeia de Canadair, seguida por Espanha, Grécia e Croácia; a França alinha 12 CL-415 « Pélican » e 6 Dash 8 « Milan » com base em Nîmes-Garons, acompanhados individualmente pelo FireSight desde a decolagem. Nas Américas, o Brasil emprega sobretudo aviões agrícolas adaptados (Air Tractor) e helicópteros contratados contra as queimadas.",
    why: "Por que não vejo nenhum avião perto de um incêndio?",
    whyText:
      "Três explicações possíveis: é noite (não há lançamentos noturnos), os meios engajados são helicópteros locais ou militares que não transmitem publicamente, ou a aeronave desligou o transponder. O FireSight mostra tudo o que emite publicamente, o que já cobre a maioria dos Canadair europeus e dos tanqueiros norte-americanos.",
    faq: [
      {
        q: "Como acompanhar os aviões de combate a incêndios ao vivo?",
        a: "Abra o mapa firesight.io: os aviões-tanque em voo aparecem em tempo real, com velocidade e altitude, ao lado dos incêndios detectados por satélite. O acompanhamento é gratuito, sem cadastro, no celular e no computador.",
      },
      {
        q: "Onde estão os Canadair agora?",
        a: "O mapa firesight.io mostra em tempo real a posição de todos os Canadair e aviões-tanque que emitem ADS-B no mundo: Itália, França, Croácia, Grécia, Espanha, América do Norte, Austrália. Clique numa aeronave para ver modelo, nacionalidade, velocidade e altitude.",
      },
      {
        q: "Os aviões de combate aparecem no Flightradar24?",
        a: "Em parte: os rastreadores genéricos os perdem entre milhares de aviões de linha. O FireSight mostra só os meios de combate a incêndios, no mesmo mapa dos focos, do vento e dos pontos de água: entende-se a missão, não só a posição.",
      },
      {
        q: "Que aviões combatem as queimadas no Brasil?",
        a: "O Brasil emprega sobretudo aviões agrícolas adaptados como o Air Tractor AT-802, além de helicópteros contratados pelos estados e pelo Ibama. Quando emitem ADS-B, o FireSight os mostra ao vivo sobre as zonas de fogo.",
      },
      {
