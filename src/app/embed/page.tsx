...
// Widget intégrable : /embed (fr) ou /embed?lang=en. Badge FireSight cliquable
...
export default async function EmbedPage({
  ...
  return (
    <div className="relative h-full w-full">
      <FireMap lang={l} />
      <a
        href={`https://firesight.io/${l}?utm_source=embed&utm_medium=widget`}
        target="_blank"
        rel="noreferrer"
      ...
      >
        🐤 firesight.io — {l === "fr" ? "carte des feux en direct" : "live fire map"}
      </a>
    </div>
  );
}
